...
public class Point implements Comparable<Point> {
    ...
    private static class BySlopeOrder implements Comparator<Point> {
        ...
        public BySlopeOrder(Point p0) {
            this.p0 = p0;
        }

        public int compare(Point p1, Point p2) {
            double p1SlopeOrder = p0.slopeTo(p1);
            double p2SlopeOrder = p0.slopeTo(p2);

            if (p1SlopeOrder == p2SlopeOrder) {
                return 0;
            }

            return p1SlopeOrder < p2SlopeOrder ? -1 : +1;
        }
    }
